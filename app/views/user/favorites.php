...
if (isset($_POST['car_id']) && isset($_POST['is_checked'])) {
    $carID = $_POST['car_id'];
    $isChecked = $_POST['is_checked'] == 'true';
    $favoritesController = new FavoritesController($conn);

    if ($isChecked) {
        $favoritesController->addFavorite($carID, $user);
    } else {
        $favoritesController->removeFavorite($carID);
    }
                        ...
                        <?php foreach ($favCars as $car): ?>
                            <div class="car-card">
                                <div class="car-card-inner">
                                    ...
                                    <div class="con-like">
                                        <input class="like" type="checkbox" title="like" name="is_checked" data-car-id="<?php echo $car['id']; ?>" checked>
